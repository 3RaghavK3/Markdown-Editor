...
const [wordsfield, linesfield, charactersfield, bytesfield] = [
  ...document.getElementById('footer').querySelectorAll('.box .value'),
];
...
clearbtn.addEventListener('click', (event) => {
  generateAlert('Are you sure you want to clear it?', event.target.id);
});
resetbtn.addEventListener('click', (event) => {
  generateAlert('Are you sure you want to reset it?', event.target.id);
});
